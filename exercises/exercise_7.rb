...
# Prompt user to create a new store
puts "Please enter a new store into the database"
print "> "
new_store = gets.chomp

# Attempt to create new store with just name input
store = Store.create(name: new_store)

# Handle errors returned by invalid store entry
if !store.save
